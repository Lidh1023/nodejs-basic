# LangGraph Agent 完全指南

> 从零开始，彻底掌握 AI Agent 的构建之道 —— 让 AI 从「只能说」进化到「能思考、能行动、能记忆」
...
🔗 **[https://github.com/Lidh1023/nodejs-basic/tree/main/langchain-learning](https://github.com/Lidh1023/nodejs-basic/tree/main/langchain-learning)**
...
- [Part 1: 基础概念](#part-1-基础概念)
  - [LangChain 与 LangGraph 的关系](#langchain-与-langgraph-的关系)
  - [什么是 Agent](#什么是-agent)
  - [Agent vs 普通 LLM](#agent-vs-普通-llm)
- [Part 2: ReAct 模式](#part-2-react-模式)
  - [ReAct 模式详解](#react-模式详解)
  - [ReAct 的核心循环](#react-的核心循环)
- [Part 3: Agent 核心组件](#part-3-agent-核心组件)
  - [组件架构图](#组件架构图)
  - [LLM（大脑）](#1-llm大脑)
  - [Tools（工具）](#2-tools工具)
  - [State（状态）](#3-state状态)
  - [Graph（流程图）](#4-graph流程图)
- [Part 4: 构建 Agent](#part-4-构建-agent)
  - [环境准备](#环境准备)
  - [完整代码示例](#完整代码示例)
  - [Agent 的工作流程](#agent-的工作流程)
- [Part 5: 记忆功能](#part-5-记忆功能)
  - [为什么需要记忆](#为什么需要记忆)
  - [MemorySaver 详解](#memorysaver-详解)
  - [thread_id 线程标识](#thread_id-线程标识)
- [Part 6: 实战案例](#part-6-实战案例)
  - [多轮对话机器人](#案例-1多轮对话机器人)
  - [带记忆的 Agent](#案例-2带记忆的-agent)
  - [智能客服 Agent](#案例-3智能客服-agent)
- [Part 7: 最佳实践](#part-7-最佳实践)
- [Part 8: 常见问题 FAQ](#part-8-常见问题-faq)
- [Part 9: 进阶主题](#part-9-进阶主题)
...
> 💡 **总结**：Agent 的**概念和组件**（如 Tools）来自 LangChain，但**构建和编排 Agent 的能力**主要由 LangGraph 提供。现在官方推荐使用 LangGraph 来构建生产级的 Agent。
...
> 🔗 仓库地址：[https://github.com/Lidh1023/nodejs-basic/tree/main/langchain-learning](https://github.com/Lidh1023/nodejs-basic/tree/main/langchain-learning)

| 文件                                 | 内容             | 预计用时 | GitHub 链接                                                                                                             |
| ------------------------------------ | ---------------- | -------- | ----------------------------------------------------------------------------------------------------------------------- |
| `src/agent.js`                       | Agent 入门 Demo  | 30 分钟  | [📄 查看代码](https://github.com/Lidh1023/nodejs-basic/tree/main/langchain-learning/src/agent.js)                       |
| `src/langgraph/06-react-agent.js`    | ReAct Agent 详解 | 30 分钟  | [📄 查看代码](https://github.com/Lidh1023/nodejs-basic/tree/main/langchain-learning/src/langgraph/06-react-agent.js)    |
| `src/langgraph/07-memory-basic.js`   | MemorySaver 基础 | 20 分钟  | [📄 查看代码](https://github.com/Lidh1023/nodejs-basic/tree/main/langchain-learning/src/langgraph/07-memory-basic.js)   |
| `src/langgraph/08-memory-chatbot.js` | 多轮对话机器人   | 30 分钟  | [📄 查看代码](https://github.com/Lidh1023/nodejs-basic/tree/main/langchain-learning/src/langgraph/08-memory-chatbot.js) |
| `src/langgraph/09-memory-agent.js`   | 带记忆的 Agent   | 30 分钟  | [📄 查看代码](https://github.com/Lidh1023/nodejs-basic/tree/main/langchain-learning/src/langgraph/09-memory-agent.js)   |
| `src/tools-demo.js`                  | Tools 使用详解   | 20 分钟  | [📄 查看代码](https://github.com/Lidh1023/nodejs-basic/tree/main/langchain-learning/src/tools-demo.js)                  |
...
> 💡 **学习建议**: 先理解 LangChain 和 LangGraph 的关系，再从简单的 Agent 开始，逐步添加记忆功能。每一步都观察 AI 是如何"思考"和"行动"的！
